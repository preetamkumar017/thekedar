...
class SubmitProgressView extends StatefulWidget {
  const SubmitProgressView({Key? key}) : super(key: key);

  @override
  _SubmitProgressViewState createState() => _SubmitProgressViewState();
}

class _SubmitProgressViewState extends State<SubmitProgressView> {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          "${spc.thekaType.value.result!.thekaName} [ ${spc.thekaType.value.result!.thekaRate}/${spc.thekaType.value.result!.rateUnit} ]",
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                              ...
                                              if(spc.siteName.value.text=="")
                                                {
                                                ...
                                                }else if(spc.progress.value.text=="")
                                                  {
                                                    Utils.flushBarErrorMessage("Progress Can not be Empty", context);
                                                      ...
                                                      {
                                                        Get.toNamed(RouteName.uploadImageView);
                                                      }
                                            },
                                            text: 'Next',
